...
1. Check the active plan (`Dashboard/Tunet/Docs/plans/consistency_driver_method_plan.md`) — card work follows the consistency-driver pass order (CD0-CD12)
...
| #9399 | 12:53 AM | ✅ | Cards/CLAUDE.md Active Plan Pointer Updated to consistency_driver_method_plan.md | ~313 |
| #9398 | " | 🔵 | Cards/CLAUDE.md References Stale Plan Path and Superseded Profile Policy | ~432 |
</claude-mem-context>